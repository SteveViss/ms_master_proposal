...
% Theorical framework (General) finir avec l'objectifs
Most phenomena in ecology occurs often gradually over the time \cite{Scheffer2001}.\\

Our hypothesis proposes the presence of alternative stable states in the transition zone between the temperate and boreal forest as a result of the progression difficulty. Under pressure from the same climatic conditions we would expect to find in boreal-temperate forests ecotone, the alternative stable states consisting of forest patches dominated by balsam fir and an another by sugar maple at same environnemental conditions\\ %% L'aménagement forestier contribuera a augmenté le nombre de patch d'érable à sucre en forêt boréal générant ainsi une importante zone de contraction entre ces deux types de forêts (contrasté dans leur dynamique).
