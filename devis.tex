...
%DG: if you include forest management, then you'll have to implement it in the simulation model and discuss it in the analysis

% DG: I wonder if you do not have too many hypotheses. To me, the most important is H1
% DG: I don't understand the formulation of H2
% DG: I would make a different prediction for climate change. Something like 'time lags in the response to climate change will be larger in areas of hysteresis'
% DG: forest management is not an attractor (an attractor is a state). The hypothesis is simply that forest management increases the rapidity of the response to climate change. 
...
%DG: how large? You mean continental scale?
...
%DG: why suddenly are you talking baout soil moisture? I don't understand the following sentence.
...
%DG: here you use the 'may', while above you were much more stronger on tihs interpretation.
...
% DG: I think here it is critical to provide the boundary conditions to define the states
 Coniferious stands are dominated by either
...
%DG: don't think it is necessary to describe that at the moment
