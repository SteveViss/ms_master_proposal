...
(Figure \ref{fig1}, lower line). In the first case, the response of forest
communities to the climate is gradual and no disctinct boundary is observed
between the temperate and the boreal forests (Figure \ref{fig1}.A); instead a
...
% sensible à l'historique du peuplement  
%invasibilité, impact sur la migration
