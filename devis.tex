...
%DG: a dernière phrase est toujours très mal écrite. À revoir. Les conditions micro n'atténuent pas les macro conditions. L'effet de micro-conditions peut atténuer l'effet de macro conditions. Et encore, c'est mal dit. En gros, ce que tu veux dire c'est que la distribution peut sous certaines conditions être davantage contrainte par les conditions microclimatiques que par les conditions macro climatiques.
...
%DG: Ça vaut la peine que tu lises le papier :
%Levine, J., Pachepsky, E., Kendal, B.E., Yelenik, S.G. & Hille Ris Lambers, J. (2006). Plant–soil feedbacks and invasive spread. Ecology Letters, 9, 1005–1014.
...
\textbf{Alternative stable states in forest ecosystems.} A
...
Ecologists recognize three possible responses of communities to a permanent change in the environment: \textbf{(A)}
...
%DG: la phrase suivante est boîteuse, reformuler.
...
%DG: écrire le système d'équations dans un espace unique plutôt que de le faire dans le text. Plus clair, plus facile à ire.
...
% DG: je ne comprend pas la second phrase
\begin{tabular}{ll}
	States  & Boundaries                            \\
	\hline
